...
//         SnackBar(content: Text('Enter valid name and 10-digit phone')),
//       );
//       return;
//     }
...
//             TextField(controller: _phoneController, decoration: InputDecoration(labelText: 'Mobile Number'), keyboardType: TextInputType.phone),
//             SizedBox(height: 20),
//             ElevatedButton(
//               onPressed: _registerCustomer,
//               child: Text('Send OTP & Register'),
//             ),
//           ],
//         ),
//       ),
